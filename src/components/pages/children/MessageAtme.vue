...
export default {
  ...
  activated () {
    this.$loading('数据加载中...')
    this.$comfun.http_get(this, this.$moment.urls.getAtInfo + '?accountId=' + this.$moment.wxUserInfo.accountId).then((response) => {
...
.list-item>div.comment-wrap>div:nth-of-type(3) {
  color: #bfb3dc;
  font-size: 0.6rem;
}
